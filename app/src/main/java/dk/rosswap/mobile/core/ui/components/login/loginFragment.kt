...
@AndroidEntryPoint
class LoginFragment : Fragment(R.layout.fragment_login) { // inflate layout
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) { // after view created
        ...
        val email = view.findViewById<EditText>(R.id.edit_email) // email input
        val password = view.findViewById<EditText>(R.id.edit_password) // password input
        val loginBtn = view.findViewById<Button>(R.id.button_login) // login button
        val googleBtn = view.findViewById<Button>(R.id.button_google) // google sign-in
